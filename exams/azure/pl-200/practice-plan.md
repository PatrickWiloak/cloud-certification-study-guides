# Power Platform Functional Consultant Associate (PL-200) Study Plan
...
This 8-week plan is designed to systematically cover all exam domains with hands-on practice and real-world scenarios.
...
- **[PL-200 Official Exam Page](https://learn.microsoft.com/en-us/certifications/exams/pl-200/)** - Registration and exam details
- **[Microsoft Learn - PL-200 Learning Path](https://learn.microsoft.com/en-us/certifications/power-platform-functional-consultant-associate/)** - FREE official study path
...
- **John Savill's PL-200 Study Cram (FREE)** - YouTube comprehensive review
...
- [ ] Practice Exam 3 (Week 7): ___% (Target: 85%+)
...
Good luck on your PL-200 journey! You've got this! 🎉
